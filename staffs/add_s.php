...
if (isset($_POST['f_name'])) {
    ...
    if($link === false){
        ...
        $query= "INSERT INTO `staffs`( `f_name`, `l_name`, `Age`, `gender`, `dept`, `uname`, `password`, `address`, `mobile`) VALUES ('$f_name','$l_name','$age','$gender','$dept','$uname','$pass','$address','$mobile')";
...
<div class="container-xl">
    <form action="add_s.php" method="post">
		...
		<div class="form-group">
        	<input type="" class="form-control" name="uname" placeholder="Uname" required="required">
        </div>
		<div class="form-group">
        	<input type="varchar" class="form-control" name="pass" placeholder="Password" required="required">
        </div>
		<div class="form-group">
		...
		<div class="form-group">
        	<input type="text" class="form-control" name="dept" placeholder="Dept" required="required">
        </div>
		...
		<div class="form-group">
            <input type="varchar" class="form-control" name="mobile" placeholder="Mobile" required="required">
        </div>        
       
		<div class="form-group">
            <button type="submit" class="btn btn-success btn-lg btn-block" name="add">Add</button>
        </div>
    </form>
